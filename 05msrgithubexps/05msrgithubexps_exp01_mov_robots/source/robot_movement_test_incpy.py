...
def main():
    # STRAIGHT MOTION
    X_left_wheel_straight = readData('straightWheelPositions.csv')[0][36:].split(',')
    
    X_left_wheel_straight_new = typeConverter(X_left_wheel_straight, float)

    Y_left_wheel_straight = readData('straightWheelPositions.csv')[1][36:].split(',')
    Y_left_wheel_straight_new = typeConverter(Y_left_wheel_straight, float)

    X_right_wheel_straight = readData('straightWheelPositions.csv')[2][36:].split(',')
    X_right_wheel_straight_new = typeConverter(X_right_wheel_straight, float)

    Y_right_wheel_straight = readData('straightWheelPositions.csv')[3][36:].split(',')
    ...
    # LEFT MOTION
    X_left_wheel_left = readData('leftWheelPositions.csv')[0][32:].split(',')
    X_left_wheel_left_new = typeConverter(X_left_wheel_left, float)

    Y_left_wheel_left = readData('leftWheelPositions.csv')[1][32:].split(',')
    Y_left_wheel_left_new = typeConverter(Y_left_wheel_left, float)

    X_right_wheel_left = readData('leftWheelPositions.csv')[2][32:].split(',')
    X_right_wheel_left_new = typeConverter(X_right_wheel_left, float)

    Y_right_wheel_left = readData('leftWheelPositions.csv')[3][32:].split(',')
    ...
    # RIGHT MOTION
    X_left_wheel_right = readData('rightWheelPositions.csv')[0][33:].split(',')
    X_left_wheel_right_new = typeConverter(X_left_wheel_right, float)

    Y_left_wheel_right = readData('rightWheelPositions.csv')[1][33:].split(',')
    Y_left_wheel_right_new = typeConverter(Y_left_wheel_right, float)

    X_right_wheel_right = readData('rightWheelPositions.csv')[2][33:].split(',')
    X_right_wheel_right_new = typeConverter(X_right_wheel_right, float)

    Y_right_wheel_right = readData('rightWheelPositions.csv')[3][33:].split(',')
