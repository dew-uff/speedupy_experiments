...
tsAvg = ts.resample(rule='1D', base=0, how='mean')#############ts.resample(rule='1D', base=0).mean()   # The daily average value for the 15 minute values
tsMin = ts.resample(rule='1D', base=0, how='min')#############ts.resample(rule='1D', base=0).min()    # The minimum value for that day
tsMax = ts.resample(rule='1D', base=0, how='max')#############ts.resample(rule='1D', base=0).max()    # The maximum value for that day
