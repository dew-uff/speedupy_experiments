import sys
sys.path.append('/home/joaopedrolopez/Downloads/AvaliacaoExperimental/Experimentos/speedupy_experiments/03dataoneexps/03dataoneexps_exp05_37_Agua_Salud_Discharge_Data')
...
def comment_3(ifile):
    ...
    parser.add_argument('-f', nargs='?', type=str, const=1, help='HDF5 input file [default: ' + ifile + ']', default=ifile)
    parser.add_argument('-ls', action='store_const', const=1, help='list available sites with engineering code and exit')
