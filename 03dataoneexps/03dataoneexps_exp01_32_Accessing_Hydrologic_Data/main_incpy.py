...
mean_discharge = ts.resample(rule='24H', base=0, how="mean")
max_discharge = ts.resample(rule='24H', base=0, how="mean")
min_discharge = ts.resample(rule='24H', base=0, how="mean")
